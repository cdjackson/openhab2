    ...
    public void handleApplicationCommandRequest(SerialMessage serialMessage, int offset, int endpoint) {
        ...
        switch (command) {
            ...
            case MANUFACTURER_SPECIFIC_REPORT:
                ...
                logger.debug(String.format("NODE %d: Manufacturer ID = 0x%04x", this.getNode().getNodeId(), this
                        .getNode().getManufacturer()));
                logger.debug(String.format("NODE %d: Device Type     = 0x%04x", this.getNode().getNodeId(), this
                        .getNode().getDeviceType()));
                logger.debug(String.format("NODE %d: Device ID       = 0x%04x", this.getNode().getNodeId(), this
                        .getNode().getDeviceId()));
                break;
            default:
